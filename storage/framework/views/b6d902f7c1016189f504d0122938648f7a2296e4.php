                    ...
                    <!--Informacion-->
                        <div class="panel panel-default">
                            ...
                            <div id="collapse5" class="panel-collapse collapse">
                                <div class="list-group">
                                    <a href="<?php echo URL::to('/juegos'); ?>"  class="list-group-item">
                                    <span class="glyphicon glyphicon-sunglasses" aria-hidden="true"></span>Ver Juegos </a>

                                    <a href="<?php echo e(url('/juegos_disponibles')); ?>" class="list-group-item">
                                    <span class="glyphicon glyphicon-search" aria-hidden="true"></span>Ver Juegos Disponibles por Fecha </a>

                                    <a href="<?php echo e(url('/juegos_mantencion')); ?>"class="list-group-item">
