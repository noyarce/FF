    ...
    <div class="container">
        <div class="row">
            <div class="panel panel-default">
                ...
                <?php echo Form::open(['route'=>'arriendo.store','class'=>'form-horizontal']); ?>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo Form::date('fecha', \Carbon\Carbon::now()->format('d-m-Y')); ?></td>
                                </tr>
                            ...
                            '00:00 - 03:00'=>'00:00 - 03:00',
                                ...
                                <tr>
                                    ...
                                    <td><?php echo Form::selectRange('ext', 0, 5, 0,['class'=>'col-sm-3  form-control']); ?></td>
                                </tr>
                                ...
                                <tr>
                                    <td><?php echo Form::label('Comentario', 'Comentario',['class'=>'col-sm-2 control-label']); ?> </td>
                                    <td> <div class=" rows=3 ">
