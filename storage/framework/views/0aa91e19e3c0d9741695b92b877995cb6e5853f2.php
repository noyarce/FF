                     ...
                     <div class="panel-group" id="accordion">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="list-group">
                                <a href="<?php echo e(url('/usuarios')); ?>" class="list-group-item" >
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse2" class="panel-collapse collapse">
                                <div class="list-group">
        <a href="<?php echo e(url('/juegos_disponibles')); ?>" class="list-group-item"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>Ver Juegos Disponibles por Fecha </a>   
        <a href="<?php echo e(url('/juegos_administrar')); ?>" class="list-group-item"><span class="glyphicon glyphicon-knight" aria-hidden="true"></span>Ver Mantencion de Juegos </a>   
        <a href="<?php echo e(url('/solicitudes_mantencion')); ?>" class="list-group-item"><span class="glyphicon glyphicon-knight" aria-hidden="true"></span>Ver Solicitudes Mantencion</a>   
        <a href="<?php echo e(url('/juegos/create')); ?>" class="list-group-item"><span class="glyphicon glyphicon-knight" aria-hidden="true"></span>Registrar Juego </a>  
          ...
          <a href="<?php echo e(url('/arriendo_pendientes')); ?>" class="list-group-item" >
            <span class="glyphicon glyphicon-list" aria-hidden="true"></span> Listar Arriendos Pendientes </a>   
                        ...
                        <div id="collapse4" class="panel-collapse collapse">
                            <div class="list-group">
                                <a href="<?php echo e(url('/contacto')); ?>" class="list-group-item">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse5" class="panel-collapse collapse">
                                <div class="list-group">
                                   <a href="<?php echo e(url('/fotos')); ?>" class="list-group-item">
                                     <span class="glyphicon glyphicon-picture" aria-hidden="true"></span> Listar Fotos </a>   
                                     <a href="<?php echo e(url('/fotos/create')); ?>" class="list-group-item">
