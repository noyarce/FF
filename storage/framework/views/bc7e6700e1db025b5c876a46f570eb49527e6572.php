<?php $__env->startSection('content'); ?>
        ...
        <div class="row">
            <div class="panel panel-default">
                    <div class="panel-heading"> Arrendar Juego(s) - Información del Cliente</div>
                        <?php echo Form::model($arriendo,['route'=>['arriendo.update',$arriendo->id],'method'=>'PUT']); ?>
                    ...
                    <?php echo Form::hidden  ('id_usuario',$arriendo->id_usuario ); ?>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><?php echo Form::text('cliente', null,['class'=>'form-control']); ?></td>
                            </tr> <tr>
                                ...
                                <tr>
                                    <td><?php echo Form::label('Fecha', 'Fecha',['class'=>'col-sm-2 control-label']); ?></td>
                                    <td><?php echo Form::date('fecha', $arriendo->fecha); ?></td>
                                </tr>

                                <tr>
                                    <td><?php echo Form::label('hora', 'hora',['class'=>'col-sm-2 control-label']); ?></td>
                                    <td>   <?php echo Form::select('hora', [
                            ...
                            '00:00 - 03:00'=>'00:00 - 03:00',
                                ...
                                <tr>
                                    <td><?php echo Form::label('hrs extra', 'hrs extra',['class'=>'col-sm-2 control-label']); ?></td>
                                    <td><?php echo Form::selectRange('ext', 0, 5, 0,['class'=>'col-sm-3  form-control'], $arriendo->ext); ?></td>
                                </tr>

                                <tr>
                                    <td><?php echo Form::label('Medio de Pago', 'Medio de Pago',['class'=>'col-sm-0 control-label']); ?></td>
                                    <td><?php echo Form::select('mdp', ['Efectivo'=>'Efectivo','Deposito'=>'Deposito','Transferencia electronica'=>'Transferencia electronica','Cheque'=>'Cheque'], 'Efectivo'); ?></td>
                                </tr>
                                ...
                                <tr>
                                    <td><?php echo Form::label('Comentario', 'Comentario',['class'=>'col-sm-2 control-label']); ?> 
                                    Use este espacio para indicar cualquier mensaje que estime conveniente 
                                    </td>
                                    <td> <div class=" rows=3 ">
                                            <?php echo Form::textarea('comentario', null,['class'=>'form-control'], $arriendo->comentario); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo Form::text('direccion', null,['class'=>'form-control'], $arriendo->direccion); ?></td>
                                </tr>
    ...
    <script>
        function initMap() {
            var chillan = new google.maps.LatLng(parseFloat(<?php echo e($arriendo->lat); ?>),parseFloat(<?php echo e($arriendo->lng); ?>));
