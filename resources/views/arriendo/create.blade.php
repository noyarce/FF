    ...
    <div class="container">
        <div class="row">
            <div class="panel panel-default">
                ...
                {!! Form::open(['route'=>'arriendo_store','class'=>'form-horizontal']) !!}
...
@if((Session::has('flash_message')) or (count( $errors ) > 0))@include('errors.panel') @endif
                    ...
                    <div class="form-group">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{!! Form::text('cliente', null,['class'=>'form-control'],  Auth::user()->name ) !!}</td>
                            </tr> <tr>
                                ...
                                <tr>
                                    <td colspan"2">
                                        {!! Form::label('Fecha', 'Fecha',['class'=>'col-sm-1 control-label']) !!}
                                        {!! Form::date('fecha', \Carbon\Carbon::now()->format('d-m-Y')) !!}
                        ...
                        <td>{!! Form::label('hrs extra', 'hrs extra',['class'=>'col-sm-2 control-label']) !!}{!! Form::selectRange('ext', 0, 5, 0,['class'=>'col-sm-3  form-control']) !!}</td>
                                </tr>

                                <tr>
                                    <td>{!! Form::label('Medio de Pago', 'Medio de Pago',['class'=>'col-sm-0 control-label']) !!}{!!  Form::select('mdp', ['Efectivo'=>'Efectivo','Deposito'=>'Deposito','Transferencia electronica'=>'Transferencia electronica','Cheque'=>'Cheque'], 'Efectivo')!!}</td>
                                
                                <td>{!! Form::label('Facturacion', 'Facturacion',['class'=>'col-sm-0 control-label']) !!} <select name="facturacion" id="facturacion">
                    ...
                    <div class="form-group">
                        <div class="trans">
                            {!! Form::submit('Guardar y pasar a seleccion de Juego(s)',['class'=>'btn btn-primary']) !!}
                            {!! Form::close() !!}
    ...
    <script type="text/javascript" src="//maps.googleapis.com/maps/api/js?key=      &libraries=places&callback=initMap"></script>
@endsection