        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    {!! Form::open(['route'=>'cotizacion_store','class'=>'form-horizontal']) !!}

                <table class="table table-bordered">
                <tbody>
                <tr>
                    <td>{!! Form::label('Nombre', 'Nombre',['class'=>'col-sm-0 control-label']) !!} </td>
                    <td>{!! Form::text('nombre_c', null,['class'=>'form-control']) !!}</td>
                 </tr>
                    <td>{!! Form::label('Empresa', 'Empresa',['class'=>'col-sm-0 control-label']) !!}</td>
                <td>{!! Form::text('empresa_c', null,['class'=>'form-control']) !!}</td>
                <tr>
                <td>{!! Form::label('E-Mail', 'E-Mail',['class'=>'col-sm-0 control-label']) !!}</td>
                    <td>{!! Form::text('mail_c', null,['class'=>'form-control']) !!}</td>
                </tr> <tr>
                    <td>{!! Form::label('Telefono de Contacto', 'Telefono de Contacto',['class'=>'col-sm-0 control-label']) !!}</td>
                    <td>{!! Form::text('telefono_c', null,['class'=>'form-control']) !!}</td>
                </tr>
                <tr>
                    <td>{!! Form::label('Fecha', 'Fecha',['class'=>'col-sm-0 control-label']) !!}</td>
                    <td>{!! Form::date('fecha_c', \Carbon\Carbon::now()->format('d-m-Y')) !!}</td>
                </tr>

                <tr>
                    <td>{!! Form::label('hora', 'hora',['class'=>'col-sm-0 control-label']) !!}</td>
                    <td>   {!!  Form::select('hora_c', [
                ...
                <tr>
                    <td>{!! Form::label('hrs extra', 'hrs extra',['class'=>'col-sm-0 control-label']) !!}</td>
                    <td>{!! Form::selectRange('ext_c', 0, 5, 0,['class'=>'col-sm-3  form-control']) !!}</td>
                </tr>

                <tr>
                    <td>{!! Form::label('Medio de Pago', 'Medio de Pago',['class'=>'col-sm-0 control-label']) !!}</td>
                    <td>{!!  Form::select('mdp_c', ['Efectivo'=>'Efectivo','Deposito'=>'Deposito','Transferencia electronica'=>'Transferencia electronica','Cheque'=>'Cheque',], 'Efectivo')!!}</td>
                ...
                <tr>
                    <td>{!! Form::label('Comentario', 'Comentario',['class'=>'col-sm-1 control-label']) !!} </td>
                    <td> <div class=" rows=3 ">
                            {!! Form::textarea('comentario_c', null,['class'=>'form-control']) !!}
                        </div></td>                </tr>

                <tr>
                    <td>{!! Form::label('Dirección', 'Dirección',['class'=>'col-sm-2 control-label']) !!}</td>
                    <td>{!! Form::text('direccion_c', null,['class'=>'form-control']) !!}</td>
                </tr>
